...
CREATE TABLE IF NOT EXISTS `fc_learn_db_test`.`cards` (
  ...
  `questionImage` VARCHAR(500) NULL DEFAULT NULL,
  `answerImage` VARCHAR(500) NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `fc_learn_db_test`.`user_cards` (
  ...
  `card_status` ENUM('new', 'low', 'medium', 'high', 'never') NULL DEFAULT NULL,
  `low_count` INT(11) NULL DEFAULT NULL,
